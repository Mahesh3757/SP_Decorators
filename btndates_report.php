                    ...
                    {               ?>
                      <tr>
                        ...
                        <td class=" text-center"><a href="#"  class=" edit_data4" id="<?php echo  ($row->ID); ?>" title="click to edit"><i class="mdi mdi-eye" aria-hidden="true"></i></a>
                          <a href="invoice_generating.php?invid=<?php echo htmlentities ($row->ID);?>" onclick="printInvoice('<?php echo htmlentities ($row->ID);?>')"><i class="mdi mdi-printer" aria-hidden="true"></i></a>
                        </td>
                      </tr>
                      <?php
                      $cnt=$cnt+1;
...
<script type="text/javascript">
  ...
  function printInvoice(invoiceId) {
    var url = 'invoice_generating.php?invid=' + invoiceId;
